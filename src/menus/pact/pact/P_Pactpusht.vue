  ...
  <div class="wrap">
    <div style="width: 90%; margin: 20px auto">
      ...
      <div class="steps-action" style="display: flex">
        <a-button
          ><router-link to="/home/Ppactpush">返回</router-link></a-button
        >
        <a-button type="primary" style="margin-left: 20px">
          <router-link to="/home/Ppactpushf">保存</router-link>
        </a-button>
        <a-button style="margin-left: 20px"
          ><router-link to="/home/Ppactpush">上一步</router-link></a-button
        >
      </div>
    </div>
  </div>
